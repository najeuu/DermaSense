  ...
  const articles = [
    {
      ...
      date: " 27 April 2023",
      content: "Skin barrier merupakan lapisan terluar kulit yang berfungsi melindungi kulit dan tubuh. Garda terdepan pelindung kulit ini bisa saja rusak karena beberapa hal sehingga menimbulkan berbagai masalah kulit. Oleh sebab itu, kesehatannya perlu dijaga dengan baik.",
      img: a1,
    },
    {
      id: 2,
      ...
      content: "Hati atau liver adalah organ penting yang berfungsi sebagai sistem detoksifikasi alami tubuh. Tanpa liver, tubuh tidak dapat menjalankan berbagai proses vital untuk bertahan hidup. Organ besar yang menyerupai bola sepak ini terletak di bagian kanan atas perut, tepat di bawah tulang rusuk. Liver memainkan peran penting dalam berbagai fungsi tubuh, termasuk membuang limbah, membantu pencernaan, menyaring darah, dan menetralisir racun. ",
      img: a2,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      date: "25 Juni 2022",
      content: "Gatal-gatal pada kulit adalah kondisi yang umum terjadi, terutama pada lansia. Cara mengatasi gatal-gatal pada kulit bisa dilakukan dengan mandi dan mengoleskan pelembap, hingga menggunakan obat-obatan dari dokter.",
      img: a4,
    },
    {
      id: 5,
    ...
    },
    {
      ...
      content: "Penyakit kulit kronis merupakan penyakit yang bersifat permanen dan tidak dapat sembuh sepenuhnya. Terdapat beberapa jenis penyakit kulit kronis yang dapat terjadi pada orang dewasa, seperti eksim hingga melanoma.",
      img: a6,
    }
  ];
