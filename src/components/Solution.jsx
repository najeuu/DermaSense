...
// Add parah as alias to tinggi for backward compatibility
CONTENT_MAP[SEVERITY_LEVELS.PARAH] = CONTENT_MAP[SEVERITY_LEVELS.TINGGI];
...
const SolutionSection = ({ section, content, color }) => (
  <div
